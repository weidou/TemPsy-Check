...
class RandomTraceGenerator(object):
  ...
  def open_file(self):
    ...
    self.locationsFile = os.path.join(os.getcwd(), '%s_%d_%d_between_mult_fixed_number.locations' % (self.property_id,self.length,RandomTraceGenerator.segment_length/1000-1))
    try:
