...
class RandomTraceGenerator(object):
  ...
  def open_file(self):
    ...
    self.locationsFile = os.path.join(os.getcwd(), '%s_%d_%d_between_one_various_lengths.locations' % (self.property_id,self.length,RandomTraceGenerator.between_end/RandomTraceGenerator.min_length-1))
    try:
